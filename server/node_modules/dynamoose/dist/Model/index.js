    ...
    batchPut(items, settings, callback) {
        ...
        const prepareResponse = async (response) => {
            ...
            return items.reduce((result, item) => {
                const unprocessedItem = tmpResultUnprocessed.find((searchItem) => Object.keys(item).every((keyProperty) => utils_1.default.object.equals(searchItem[keyProperty], item[keyProperty])));
                if (unprocessedItem) {
